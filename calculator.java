...
public class calculator extends javax.swing.JFrame {
    ...
    public void enable() {
        ...
        jRadioButton1.setEnabled(false);     // Кнопка ВКЛ не активна
        jRadioButton2.setEnabled(true);     //Кнопка ВЫКЛ активна
    ...
    public void disable() {
        ...
        jRadioButton1.setEnabled(true);    // Кнопка включения
        jRadioButton2.setEnabled(false);   // Кнопка выключения
    ...
    private void jRadioButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton2ActionPerformed
        disable(); // вызывает метод disable
    }//GEN-LAST:event_jRadioButton2ActionPerformed

    private void jRadioButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton1ActionPerformed
        enable(); //вызывает метов enable
